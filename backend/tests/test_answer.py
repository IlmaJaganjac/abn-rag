...
def test_answer_question_preserves_multiple_grounded_citations(monkeypatch) -> None:
    chunks = [
        _chunk(source="asml.pdf", page=301, text="Total employees 44,209 FTEs", idx=0),
        _chunk(source="asml.pdf", page=302, text="Total net sales 28,263 million", idx=1),
    ]
    parsed = LLMAnswer(
        answer="ASML had 44,209 FTEs and net sales of 28,263 million.",
        verbatim="44,209 FTEs",
        citations=[
            Citation(source="asml.pdf", page=301, quote="44,209 FTEs"),
            Citation(source="asml.pdf", page=302, quote="Total net sales 28,263 million"),
        ],
        refused=False,
        refusal_reason=None,
    )
    ...
    answer, _ = _answer_with_fake_llm(
        monkeypatch,
        question="How many employees and what net sales did ASML have in 2025?",
        chunks=chunks,
        parsed=parsed,
    )
    ...
    assert [c.page for c in answer.citations] == [301, 302]
